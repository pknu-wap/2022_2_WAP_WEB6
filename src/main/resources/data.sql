INSERT INTO procon_topic(id, content, due_date, pro_con, reason, topic)
VALUES (1, '1번째 content', '2022-02-22', true, '1번째 이유', '1번째 topic');
INSERT INTO procon_topic(id, content, due_date, pro_con, reason, topic)
VALUES (2, '2번째 content', '2022-02-23', true, '2번째 이유', '2번째 topic');
INSERT INTO procon_topic(id, content, due_date, pro_con, reason, topic)
VALUES (3, '3번째 content', '2022-02-24', true, '3번째 이유', '3번째 topic');
