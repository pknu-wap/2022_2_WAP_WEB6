...
INSERT INTO procon_topic(id, due_date, pro_con, reason, topic, user_id, book_id)
VALUES (1,  '2022-02-22', true, '1번째 이유', '1번째 topic', 1, 1);
INSERT INTO procon_topic(id, due_date, pro_con, reason, topic, user_id, book_id)
VALUES (2,  '2022-02-23', true, '2번째 이유', '2번째 topic', 1, 2);
INSERT INTO procon_topic(id, due_date, pro_con, reason, topic, user_id, book_id)
VALUES (3, '2022-02-24', true, '3번째 이유', '3번째 topic', 2, 3);
INSERT INTO procon_topic(id, due_date, pro_con, reason, topic, user_id, book_id)
VALUES (4,  '2022-02-24', true, '3번째 이유', '3번째 topic', 2, 3);
